            ...
            options: [
                {
                    ...
                    heading: 'Idealne rozwiązanie do prezentacji oferty firmy i budowania wizerunku oraz widoczności w Google za pomocą bloga.',
            ...
            <div className='mt-8'>
                {pricingOptions.map((category) =>
                    category.options.map((option, index) => (
                        <div key={index} className='bg-gray-100 p-4 rounded-lg [box-shadow:_0px_4px_33px_rgb(0_0_0_/_25%)] mb-6'>
