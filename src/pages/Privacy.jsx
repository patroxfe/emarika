	...
	return (
		<div className='bg-customGray py-52'>
			<div className='max-w-4xl mx-auto p-6 bg-white [box-shadow:_0px_4px_33px_rgb(0_0_0_/_25%)] rounded-lg text-black relative'>
				...
				<h1 className='text-2xl font-bold mb-6'>Polityka prywatności eMarika.pl</h1>
				...
				<section className='mb-6'>
					...
					<p>1.2. Operatorami serwisu oraz Administratorami danych osobowych jest: Patryk Sulich i Rafał Drużba</p>
				...
				<section className='mb-6'>
					...
					<p>5.1. Serwis zbiera informacje podane dobrowolnie przez użytkownika, w tym dane osobowe, o ile zostaną one podane.</p>
					<p>5.2. Serwis może zapisać informacje o parametrach połączenia (oznaczenie czasu, adres IP).</p>
					<p>5.3. Serwis, w niektórych wypadkach, może zapisać informację ułatwiającą powiązanie danych w formularzu z adresem e-mail użytkownika wypełniającego formularz. W takim wypadku adres e-mail użytkownika pojawia się wewnątrz adresu url strony zawierającej formularz.</p>
					<p>5.4. Dane podane w formularzu są przetwarzane w celu wynikającym z funkcji konkretnego formularza, np. w celu dokonania procesu obsługi zgłoszenia serwisowego lub kontaktu handlowego, rejestracji usług itp. Każdorazowo kontekst i opis formularza w czytelny sposób informuje, do czego on służy.</p>
				</section>

				<section className='mb-6'>
					<h2 className='text-xl font-semibold mb-2'>6. Logi Administratora</h2>
					<p>6.1. Informacje zachowaniu użytkowników w serwisie mogą podlegać logowaniu. Dane te są wykorzystywane w celu administrowania serwisem.</p>
				</section>
