		...
		<div className='bg-customGray py-52'>
			<div className='max-w-4xl mx-auto p-6 bg-white [box-shadow:_0px_4px_33px_rgb(0_0_0_/_25%)] rounded-lg text-black relative'>
				...
				<h1 className='text-2xl font-bold mb-6'>
					Polityka prywatności eMarika.pl
				</h1>
				...
				<section className='mb-6'>
					...
					<p>
						...
						adresem url: emarika.pl.
					</p>
					<p>
						1.2. Operatorami serwisu oraz Administratorami danych osobowych
						jest: Paweł Drużba
					</p>
					<p>
						1.3. Adres kontaktowy poczty elektronicznej operatorów:
						patryksulich42@gmail.com i rafaldruzba@op.pl
					</p>
					<p>
						1.4. Operator jest Administratorem Twoich danych osobowych w
					...
					<p>
						1.6. Serwis realizuje funkcje pozyskiwania informacji o
				...
				<section className='mb-6'>
					...
					<p>
						2.1. Dane osobowe przechowywane w bazie danych są zaszyfrowane w
					...
					<p>
						2.2. Istotnym elementem ochrony danych jest regularna aktualizacja
				...
				<section className='mb-6'>
					...
					<p>
						3.1. Serwis jest hostowany (technicznie utrzymywany) na serwerach
						operatora: Hostinger
					</p>
					<p>
						3.2. Firma hostingowa w celu zapewnienia niezawodności technicznej
						prowadzi logi na poziomie serwera. Zapisowi mogą podlegać:
					</p>
					<div className='ml-6'>
						<p>
							a) zasoby określone identyfikatorem URL (adresy żądanych zasobów –
							stron, plików),
						</p>
						...
						<p>
							{' '}
							d) nazwę stacji klienta – identyfikacja realizowana przez protokół
							HTTP
						</p>
						<p>
							{' '}
							e) informacje o błędach jakie nastąpiły przy realizacji transakcji
							HTTP
						</p>
						<p>
							{' '}
							f) adres URL strony poprzednio odwiedzanej przez użytkownika
						...
						<p>
							{' '}
							i) informacje diagnostyczne związane z procesem samodzielnego
							zamawiania usług poprzez rejestratory na stronie
						</p>
						<p>
							{' '}
							j) informacje związane z obsługą poczty elektronicznej kierowanej
				...
				<section className='mb-6'>
					...
					<p>
						4.1. W niektórych sytuacjach Administrator ma prawo przekazywać
					...
					<div className='ml-6'>
						...
						<p>
							{' '}
							b) poprzez wyświetlenie twojej witryny, nazwy firmy, ewentualnie
							krótkiego opisu na stronie internetowej eMarika.pl w celach
							promocyjnych.
						</p>
					</div>
					<p>
						4.2. Twoje dane osobowe przetwarzane przez Administratora nie
						dłużej, niż jest to konieczne do wykonania związanych z nimi
						czynności określonych osobnymi przepisami (np. o prowadzeniu
						rachunkowości). W odniesieniu do danych marketingowych dane nie będą
					...
					<p>
						4.4. Przysługuje Ci prawo do złożenia sprzeciwu w zakresie
					...
					<p>
						4.5. Na działania Administratora przysługuje skarga do Prezesa
						Urzędu Ochrony Danych Osobowych, ul. Stawki 2, 00-193 Warszawa.
					</p>
					<p>
						4.6. Podanie danych osobowych jest dobrowolne, lecz niezbędne do
						obsługi Serwisu.
					</p>
					<p>
						4.7. W stosunku do Ciebie mogą być podejmowane czynności polegające
					...
					<p>
						4.8. Dane osobowe nie są przekazywane od krajów trzecich w
				...
				<section className='mb-6'>
					...
					<p>
						5.1. Serwis zbiera informacje podane dobrowolnie przez użytkownika,
						w tym dane osobowe, o ile zostaną one podane.
					</p>
					<p>
						5.2. Serwis może zapisać informacje o parametrach połączenia
						(oznaczenie czasu, adres IP).
					</p>
					<p>
						5.3. Serwis, w niektórych wypadkach, może zapisać informację
					...
					<p>
						5.4. Dane podane w formularzu są przetwarzane w celu wynikającym z
				...
				<section className='mb-6'>
					...
					<p>
						6.1. Informacje zachowaniu użytkowników w serwisie mogą podlegać
