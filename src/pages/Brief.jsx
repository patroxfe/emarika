...
export default function Brief() {
	...
	const handleSubmit = async e => {
		...
		try {
			...
			if (response.ok) {
				setShowPopup({ show: true, message: 'Formularz został poprawnie wysłany!' })
			...
			setShowPopup({ show: true, message: ' "Catch error" przykro nam nie udało się wysłąć formularza' })
