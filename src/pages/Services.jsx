	...
	return (
		<>
			<section className='bg-white m-auto py-8'>
				...
				<div className='wrapper flex flex-col gap-y-16 md:gap-y-16 my-20 md:flex-row md:flex-wrap md:justify-center md:items-center'>
					{services.map((item, index) => (
						<div
							key={index}
							className=' md:min-w-[30%] [box-shadow:_0px_4px_33px_rgb(0_0_0_/_25%)] text-center py-10 md:mx-5 rounded cursor-pointer relative hover:scale-110 transition fix-block'>
							<div
