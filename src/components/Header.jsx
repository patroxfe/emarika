...
import { scrollToSection } from './Nav'; // importujemy funkcję scrollToSection z Nav.jsx

export default function Header() {
    const handleSprawdzOferteClick = () => {
        scrollToSection('cennik-i-oferty'); // wywołujemy funkcję scrollToSection z Nav.jsx
    };
